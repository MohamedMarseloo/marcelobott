...
client.on("message", message => {
 ...
 if (message.content === "-help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『 THE LORD'S BOT』 『اسم البوت』", true)
      
      .addField("『مارسيلو』『مصمم البوت』", true)
      
      .addField("『-help『لو عاوز الاوامر مع اوامر اضافية』😵", true)
      
	    .addField("『-help『لو عاوز الاوامر العامة』😳", true)
	    
      .addField("『-help『 لو عاوز الاوامر الادارية』🤒", true)
...
👑-cv  مـلاحظه: الاسم انت تختاره『لي انشاء روم كتابي』

👑-cv  مـلاحظه: الاسم انت تختاره『لي انشاء روم صوتي』

👑-deletechannel  『كـود يحذف الـروم سواء صوتي او كتابي』
...
-invites | القسم الاول لي اضافه البوت 

-support| القسم الثاني  الدعم الفني و المساعدة

القسم الثالث مصمم البوت | Marcelo
...
القسم الثالث مصمم البوت | Marceloo
...
.addField(':arrow_down:Rooms  Name. :heavy_check_mark::',`**[${channels}]**`)
  ...
  client.on('message', message => {
    ...
    client.on('message', message => {
      ...
      .addField(':orange_book:| الاصفر',`${message.guild.members.filter(m=>m.presence.status == 'idle').size}`)
...
client.on('ready', () => {
   client.user.setGame(" THE LORD'S  Type -help");
}); 
...
client.login('NjEwNzU0OTQxOTE2Njc2MDk5.XVJ4fQ.xgDYLF9NzbMaSyeHGBZuoLffNNw');
